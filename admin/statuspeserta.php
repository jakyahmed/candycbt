...
$id = $_GET['id'];
$nilaiq = mysqli_query($koneksi, "SELECT *  FROM nilai  s LEFT JOIN ujian c ON s.id_ujian=c.id_ujian  where c.status='1' and s.id_siswa<>'' and s.id_mapel='$id' GROUP by s.id_nilai DESC");
